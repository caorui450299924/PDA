...
public class YCStockAdapter extends RecyclerView.Adapter<YCStockAdapter.ViewHolder> {
    private List<YC_Ckd> yc_ckds;
    private Context contxt;
    private YCStock activity;
    ...
    public YCStockAdapter(List<YC_Ckd> list, Context context, YCStock activity){
        yc_ckds=list;
        this.contxt = (YCStock) context;
        this.activity = (YCStock) activity;
    }

    @Override
    public YCStockAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_ycstock,parent,false);
        final YCStockAdapter.ViewHolder holder = new YCStockAdapter.ViewHolder(view);
        holder.wlview.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Log.d("~~~~","~~~~~~");
                Intent intent = new Intent(YCStockAdapter.this.activity,YCStock_Material.class);
    ...
    @Override
    public void onBindViewHolder(YCStockAdapter.ViewHolder holder, int position) {
